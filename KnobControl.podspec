...
Pod::Spec.new do |s|
  ...
  s.author             = { "zgpeace" => "zgpeace@gmail.com" }
  # Or just: s.author    = "zgpeace"
  # s.authors            = { "zgpeace" => "zgpeace@gmail.com" }
  # s.social_media_url   = "http://twitter.com/zgpeace"
  ...
  s.source       = { :git => 'https://github.com/zgpeace/KnobControl.git', :tag => '1.0.0' }
